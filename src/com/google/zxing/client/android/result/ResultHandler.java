...
public abstract class ResultHandler {
  ...
  private static final String   TAG                  = ResultHandler.class
                                                         .getSimpleName();
  ...
  final void addPhoneOnlyContact(String[] phoneNumbers, String[] phoneTypes) {
    addContact(null, null, null, phoneNumbers, phoneTypes, null, null, null,
        null, null, null, null, null, null, null, null);
  }

  final void addEmailOnlyContact(String[] emails, String[] emailTypes) {
    addContact(null, null, null, null, null, emails, emailTypes, null, null,
  ...
  final void addContact(String[] names, String[] nicknames,
      ...
      String instantMessenger, String address, String addressType, String org,
  ...
  final void sendEmail(String[] to, String[] cc, String[] bcc, String subject,
      String body) {
  ...
  final void rawLaunchIntent(Intent intent) {
    if (intent != null) {
      ...
      Log.d(TAG,
          "Launching intent: " + intent + " with extras: " + intent.getExtras());
  ...
  private String parseCustomSearchURL() {
    ...
    if (customProductSearch != null && customProductSearch.trim().isEmpty()) { return null; }
  ...
  final String fillInCustomSearchURL(String text) {
    ...
    if (rawResult != null) {
      ...
      url = url.replaceFirst("%f(?![0-9a-f])", rawResult.getBarcodeFormat()
          .toString());
      if (url.contains("%t")) {
