...
import com.google.zxing.client.android.history.*;
...
public final class CaptureActivity extends Activity implements
  ...
  protected void onResume() {
    ...
    if (prefs
        .getBoolean(PreferencesActivity.KEY_DISABLE_AUTO_ORIENTATION, true)) {
  ...
  private static boolean isZXingURL(String dataString) {
    ...
    for (String url : ZXING_URLS) {
      if (dataString.startsWith(url)) { return true; }
    }
    return false;
  }
  ...
  private void handleDecodeExternally(Result rawResult,
    ...
    if (source == IntentSource.NATIVE_APP_INTENT) {
      ...
      intent.putExtra(Intents.Scan.RESULT_FORMAT, rawResult.getBarcodeFormat()
          .toString());
  ...
  private void initCamera(SurfaceHolder surfaceHolder) {
    if (surfaceHolder == null) { throw new IllegalStateException(
