...
public final class SearchBookContentsActivity extends Activity {
  ...
  private static final Pattern       TAG_PATTERN          = Pattern
                                                              .compile("\\<.*?\\>");
  private static final Pattern       LT_ENTITY_PATTERN    = Pattern
                                                              .compile("&lt;");
  private static final Pattern       GT_ENTITY_PATTERN    = Pattern
                                                              .compile("&gt;");
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (intent == null
        || !intent.getAction().equals(Intents.SearchBookContents.ACTION)) {
      finish();
      return;
    }
  ...
  private void launchSearch() {
    ...
    if (query != null && !query.isEmpty()) {
      ...
      networkTask
          .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, query, isbn);
